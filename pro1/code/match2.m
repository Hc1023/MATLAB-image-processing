...
HistDistR1=match(Ir1,Jr1);
HistDistR2=match(Ir2,Jr2);
HistDistR3=match(Ir3,Jr3);
...
HistDistC1=match(Ic1,Jc1);
HistDistC2=match(Ic2,Jc2);
HistDistC3=match(Ic3,Jc3);
...
HistDistA1=match(Ia1,Ja1);
HistDistA2=match(Ia2,Ja2);
HistDistA3=match(Ia3,Ja3);
HistDistA4=match(Ia4,Ja4);
...
HistDist=(HistDistR+HistDistC+HistDistA)/3;
